...
ThemesService ts = Get.isRegistered<ThemesService>()
    ? Get.find<ThemesService>()
    : Get.put(ThemesService());
...
class ThemesService extends GetxService {
  ...
  List<ThemeStruct> get defaultThemes => [
        ...
        ...FlexScheme.values
            ...
            .map((e) => [
                  ThemeStruct(
                    name:
                        "${e.name.split(RegExp(r"(?=[A-Z])")).join(" ").capitalize} ☀",
                    themeData: FlexThemeData.light(
                        ...
                        .copyWith(
                          ...
                          BubbleText(
                            bubbleText:
                                Typography.englishLike2021.bodyMedium!.copyWith(
                              fontSize: 15,
                              height: Typography
                                      .englishLike2021.bodyMedium!.height! *
                                  0.85,
                            ),
                          ),
                        ]),
                  ...
                  ThemeStruct(
                    ...
                    themeData: FlexThemeData.dark(
                        ...
                        .copyWith(
                            textTheme: Typography.englishLike2021
                                .merge(Typography.whiteMountainView),
                            splashFactory: InkSparkle.splashFactory,
                            extensions: [
                          BubbleText(
                            bubbleText:
  ...
  bool inDarkMode(BuildContext context) => (AdaptiveTheme.of(context).mode ==
  ...
  void updateMusicTheme(BuildContext context, Uint8List art) async {
    final darkTheme =
        ThemeStruct.getThemes().firstWhere((e) => e.name == "Music Theme 🌙");
    final lightTheme =
        ThemeStruct.getThemes().firstWhere((e) => e.name == "Music Theme ☀");
    final lightScheme = await ColorScheme.fromImageProvider(
        provider: MemoryImage(art), brightness: Brightness.light);
    final darkScheme = await ColorScheme.fromImageProvider(
        provider: MemoryImage(art), brightness: Brightness.dark);
  ...
  void _loadTheme(BuildContext context,
      {ThemeStruct? lightOverride, ThemeStruct? darkOverride}) {
  ...
  Tuple2 getStructsFromData(ThemeData light, ThemeData dark) {
    return Platform.isWindows
        ? _applyWindowsAccent(light, dark)
        : _applyMonet(light, dark);
  }
  ...
  Future<ThemeStruct> revertToPreviousDarkTheme() async {
    ...
    ThemeStruct? previous =
        allThemes.firstWhereOrNull((e) => e.name == darkName);

    previous ??=
        defaultThemes.firstWhere((element) => element.name == "OLED Dark");
  ...
  Future<ThemeStruct> revertToPreviousLightTheme() async {
    ...
    ThemeStruct? previous =
        allThemes.firstWhereOrNull((e) => e.name == lightName);

    previous ??=
        defaultThemes.firstWhere((element) => element.name == "Bright White");
  ...
  Future<void> changeTheme(BuildContext context,
      {ThemeStruct? light, ThemeStruct? dark}) async {
    light?.save();
    dark?.save();
  ...
  Tuple2<ThemeData, ThemeData> _applyMonet(ThemeData light, ThemeData dark) {
    if (ss.settings.monetTheming.value == Monet.harmonize &&
        monetPalette != null) {
      light = light.copyWith(
        colorScheme: light.colorScheme.copyWith(
          ...
          secondary: light.colorScheme.secondary
              .harmonizeWith(Color(monetPalette!.secondary.get(40))),
          onSecondary: light.colorScheme.onSecondary
              .harmonizeWith(Color(monetPalette!.secondary.get(100))),
          secondaryContainer: light.colorScheme.secondaryContainer
              .harmonizeWith(Color(monetPalette!.secondary.get(90))),
          onSecondaryContainer: light.colorScheme.onSecondaryContainer
              .harmonizeWith(Color(monetPalette!.secondary.get(10))),
          tertiary: light.colorScheme.tertiary
              .harmonizeWith(Color(monetPalette!.tertiary.get(40))),
          onTertiary: light.colorScheme.onTertiary
              .harmonizeWith(Color(monetPalette!.tertiary.get(100))),
          tertiaryContainer: light.colorScheme.tertiaryContainer
              .harmonizeWith(Color(monetPalette!.tertiary.get(90))),
          onTertiaryContainer: light.colorScheme.onTertiaryContainer
              .harmonizeWith(Color(monetPalette!.tertiary.get(10))),
          error: light.colorScheme.error
              .harmonizeWith(Color(monetPalette!.error.get(40))),
          onError: light.colorScheme.onError
              .harmonizeWith(Color(monetPalette!.error.get(100))),
          errorContainer: light.colorScheme.errorContainer
              .harmonizeWith(Color(monetPalette!.error.get(90))),
          onErrorContainer: light.colorScheme.onErrorContainer
              .harmonizeWith(Color(monetPalette!.error.get(10))),
          background: light.colorScheme.background
              .harmonizeWith(Color(monetPalette!.neutral.get(99))),
          onBackground: light.colorScheme.onBackground
              .harmonizeWith(Color(monetPalette!.neutral.get(10))),
          surface: light.colorScheme.surface
              .harmonizeWith(Color(monetPalette!.neutral.get(99))),
          onSurface: light.colorScheme.onSurface
              .harmonizeWith(Color(monetPalette!.neutral.get(10))),
          surfaceVariant: light.colorScheme.surfaceVariant
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(90))),
          onSurfaceVariant: light.colorScheme.onSurfaceVariant
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(30))),
          outline: light.colorScheme.outline
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(50))),
          outlineVariant: light.colorScheme.outlineVariant
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(80))),
          shadow: light.colorScheme.shadow
              .harmonizeWith(Color(monetPalette!.neutral.get(0))),
          inverseSurface: light.colorScheme.inverseSurface
              .harmonizeWith(Color(monetPalette!.neutral.get(20))),
          onInverseSurface: light.colorScheme.onInverseSurface
              .harmonizeWith(Color(monetPalette!.neutral.get(95))),
          inversePrimary: light.colorScheme.inversePrimary
              .harmonizeWith(Color(monetPalette!.primary.get(80))),
          scrim: light.colorScheme.outlineVariant
              .harmonizeWith(Color(monetPalette!.neutral.get(0))),
        ),
      );
      dark = dark.copyWith(
        colorScheme: dark.colorScheme.copyWith(
          ...
          secondary: dark.colorScheme.secondary
              .harmonizeWith(Color(monetPalette!.secondary.get(80))),
          onSecondary: dark.colorScheme.onSecondary
              .harmonizeWith(Color(monetPalette!.secondary.get(20))),
          secondaryContainer: dark.colorScheme.secondaryContainer
              .harmonizeWith(Color(monetPalette!.secondary.get(30))),
          onSecondaryContainer: dark.colorScheme.onSecondaryContainer
              .harmonizeWith(Color(monetPalette!.secondary.get(90))),
          tertiary: dark.colorScheme.tertiary
              .harmonizeWith(Color(monetPalette!.tertiary.get(80))),
          onTertiary: dark.colorScheme.onTertiary
              .harmonizeWith(Color(monetPalette!.tertiary.get(20))),
          tertiaryContainer: dark.colorScheme.tertiaryContainer
              .harmonizeWith(Color(monetPalette!.tertiary.get(30))),
          onTertiaryContainer: dark.colorScheme.onTertiaryContainer
              .harmonizeWith(Color(monetPalette!.tertiary.get(90))),
          error: dark.colorScheme.error
              .harmonizeWith(Color(monetPalette!.error.get(80))),
          onError: dark.colorScheme.onError
              .harmonizeWith(Color(monetPalette!.error.get(20))),
          errorContainer: dark.colorScheme.errorContainer
              .harmonizeWith(Color(monetPalette!.error.get(30))),
          onErrorContainer: dark.colorScheme.onErrorContainer
              .harmonizeWith(Color(monetPalette!.error.get(80))),
          background: dark.colorScheme.background
              .harmonizeWith(Color(monetPalette!.neutral.get(10))),
          onBackground: dark.colorScheme.onBackground
              .harmonizeWith(Color(monetPalette!.neutral.get(90))),
          surface: dark.colorScheme.surface
              .harmonizeWith(Color(monetPalette!.neutral.get(10))),
          onSurface: dark.colorScheme.onSurface
              .harmonizeWith(Color(monetPalette!.neutral.get(90))),
          surfaceVariant: dark.colorScheme.surfaceVariant
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(30))),
          onSurfaceVariant: dark.colorScheme.onSurfaceVariant
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(80))),
          outline: dark.colorScheme.outline
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(60))),
          outlineVariant: dark.colorScheme.outlineVariant
              .harmonizeWith(Color(monetPalette!.neutralVariant.get(30))),
          shadow: dark.colorScheme.shadow
              .harmonizeWith(Color(monetPalette!.neutral.get(0))),
          inverseSurface: dark.colorScheme.inverseSurface
              .harmonizeWith(Color(monetPalette!.neutral.get(90))),
          onInverseSurface: dark.colorScheme.onInverseSurface
              .harmonizeWith(Color(monetPalette!.neutral.get(20))),
          inversePrimary: dark.colorScheme.inversePrimary
              .harmonizeWith(Color(monetPalette!.primary.get(40))),
          scrim: dark.colorScheme.outlineVariant
              .harmonizeWith(Color(monetPalette!.neutral.get(0))),
        ),
      );
  ...
  Tuple2<ThemeData, ThemeData> _applyWindowsAccent(
    ...
    light = light.copyWith(
      colorScheme: light.colorScheme.copyWith(
        ...
        secondary: light.colorScheme.secondary
            .harmonizeWith(Color(palette.secondary.get(40))),
        onSecondary: light.colorScheme.onSecondary
            .harmonizeWith(Color(palette.secondary.get(100))),
        secondaryContainer: light.colorScheme.secondaryContainer
            .harmonizeWith(Color(palette.secondary.get(90))),
        onSecondaryContainer: light.colorScheme.onSecondaryContainer
            .harmonizeWith(Color(palette.secondary.get(10))),
        tertiary: light.colorScheme.tertiary
            .harmonizeWith(Color(palette.tertiary.get(40))),
        onTertiary: light.colorScheme.onTertiary
            .harmonizeWith(Color(palette.tertiary.get(100))),
        tertiaryContainer: light.colorScheme.tertiaryContainer
            .harmonizeWith(Color(palette.tertiary.get(90))),
        onTertiaryContainer: light.colorScheme.onTertiaryContainer
            .harmonizeWith(Color(palette.tertiary.get(10))),
        error:
            light.colorScheme.error.harmonizeWith(Color(palette.error.get(40))),
        onError: light.colorScheme.onError
            .harmonizeWith(Color(palette.error.get(100))),
        errorContainer: light.colorScheme.errorContainer
            .harmonizeWith(Color(palette.error.get(90))),
        onErrorContainer: light.colorScheme.onErrorContainer
            .harmonizeWith(Color(palette.error.get(10))),
        background: light.colorScheme.background
            .harmonizeWith(Color(palette.neutral.get(99))),
        onBackground: light.colorScheme.onBackground
            .harmonizeWith(Color(palette.neutral.get(10))),
        surface: light.colorScheme.surface
            .harmonizeWith(Color(palette.neutral.get(99))),
        onSurface: light.colorScheme.onSurface
            .harmonizeWith(Color(palette.neutral.get(10))),
        surfaceVariant: light.colorScheme.surfaceVariant
            .harmonizeWith(Color(palette.neutralVariant.get(90))),
        onSurfaceVariant: light.colorScheme.onSurfaceVariant
            .harmonizeWith(Color(palette.neutralVariant.get(30))),
        outline: light.colorScheme.outline
            .harmonizeWith(Color(palette.neutralVariant.get(50))),
        outlineVariant: light.colorScheme.outlineVariant
            .harmonizeWith(Color(palette.neutralVariant.get(80))),
        shadow: light.colorScheme.shadow
            .harmonizeWith(Color(palette.neutral.get(0))),
        inverseSurface: light.colorScheme.inverseSurface
            .harmonizeWith(Color(palette.neutral.get(20))),
        onInverseSurface: light.colorScheme.onInverseSurface
            .harmonizeWith(Color(palette.neutral.get(95))),
        inversePrimary: light.colorScheme.inversePrimary
            .harmonizeWith(Color(palette.primary.get(80))),
        scrim: light.colorScheme.outlineVariant
            .harmonizeWith(Color(palette.neutral.get(0))),
      ),
    );
    dark = dark.copyWith(
      colorScheme: dark.colorScheme.copyWith(
        ...
        secondary: dark.colorScheme.secondary
            .harmonizeWith(Color(palette.secondary.get(80))),
        onSecondary: dark.colorScheme.onSecondary
            .harmonizeWith(Color(palette.secondary.get(20))),
        secondaryContainer: dark.colorScheme.secondaryContainer
            .harmonizeWith(Color(palette.secondary.get(30))),
        onSecondaryContainer: dark.colorScheme.onSecondaryContainer
            .harmonizeWith(Color(palette.secondary.get(90))),
        tertiary: dark.colorScheme.tertiary
            .harmonizeWith(Color(palette.tertiary.get(80))),
        onTertiary: dark.colorScheme.onTertiary
            .harmonizeWith(Color(palette.tertiary.get(20))),
        tertiaryContainer: dark.colorScheme.tertiaryContainer
            .harmonizeWith(Color(palette.tertiary.get(30))),
        onTertiaryContainer: dark.colorScheme.onTertiaryContainer
            .harmonizeWith(Color(palette.tertiary.get(90))),
        error:
            dark.colorScheme.error.harmonizeWith(Color(palette.error.get(80))),
        onError: dark.colorScheme.onError
            .harmonizeWith(Color(palette.error.get(20))),
        errorContainer: dark.colorScheme.errorContainer
            .harmonizeWith(Color(palette.error.get(30))),
        onErrorContainer: dark.colorScheme.onErrorContainer
            .harmonizeWith(Color(palette.error.get(80))),
        background: dark.colorScheme.background
            .harmonizeWith(Color(palette.neutral.get(10))),
        onBackground: dark.colorScheme.onBackground
            .harmonizeWith(Color(palette.neutral.get(90))),
        surface: dark.colorScheme.surface
            .harmonizeWith(Color(palette.neutral.get(10))),
        onSurface: dark.colorScheme.onSurface
            .harmonizeWith(Color(palette.neutral.get(90))),
        ...
        onSurfaceVariant: dark.colorScheme.onSurfaceVariant
            .harmonizeWith(Color(palette.neutralVariant.get(80))),
        outline: dark.colorScheme.outline
            .harmonizeWith(Color(palette.neutralVariant.get(60))),
        outlineVariant: dark.colorScheme.outlineVariant
            .harmonizeWith(Color(palette.neutralVariant.get(30))),
        shadow: dark.colorScheme.shadow
            .harmonizeWith(Color(palette.neutral.get(0))),
        ...
        onInverseSurface: dark.colorScheme.onInverseSurface
            .harmonizeWith(Color(palette.neutral.get(20))),
        inversePrimary: dark.colorScheme.inversePrimary
            .harmonizeWith(Color(palette.primary.get(40))),
        scrim: dark.colorScheme.outlineVariant
            .harmonizeWith(Color(palette.neutral.get(0))),
      ),
    );
