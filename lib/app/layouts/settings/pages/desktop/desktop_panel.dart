...
class _DesktopPanelState extends OptimizedState<DesktopPanel> {
  final RxList<bool> showButtons =
      RxList<bool>.filled(ReactionTypes.toList().length + 1, false);
  final int maxActions = Platform.isWindows
      ? 5
      : ss.settings.actionList.length; // Don't limit actions on Linux
                    ...
                    () => SettingsSwitch(
                      onChanged: (bool val) async {
                        ss.settings.launchAtStartup.value =
                            await ss.setupLaunchAtStartup(val,
                                  ...
                                  child: ReorderableWrap(
                                    ...
                                    onReorder: (int oldIndex, int newIndex) {
                                      List<String> selected = ss
                                          .settings.selectedActionIndices
                                          .map((index) =>
                                              ss.settings.actionList[index])
                                          .toList();
                                      String? temp =
                                          ss.settings.actionList[oldIndex];
                                      ...
                                      List<int> selectedIndices = selected
                                          .map((s) =>
                                              ss.settings.actionList.indexOf(s))
                                          .toList();
                                      ...
                                      (int index) => MouseRegion(
                                        ...
                                        child: Obx(
                                          () {
                                            ...
                                            bool disabled = (!ss.settings
                                                    .enablePrivateAPI.value &&
                                                value != "Mark Read");
                          ...
                          () {
                            ...
                            return Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  Obx(() {
                                    int markReadIndex = ss.settings.actionList
                                        .indexOf("Mark Read");
                                    ...
                                    bool showMarkRead = ss
                                        .settings.selectedActionIndices
                                        .contains(markReadIndex);
                                    ns.listener.value;
                                    context.width;
                                    double margin = 20;
