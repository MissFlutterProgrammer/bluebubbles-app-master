...
class CupertinoHeader extends StatelessWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize => Size.fromHeight(
      (Get.context!.orientation == Orientation.landscape && Platform.isAndroid
              ? 55
              : 75) *
      ...
      children: [
        ...
        Obx(() {
          final _count = widget.controller.inSelectMode.value
              ...
              : GlobalChatService.unreadCount.value;
      ...
      updateObx(() {
        ...
        sub = titleQuery.listen((Query<Chat> query) async {
          final chat = await runAsync(() {
            final cquery =
                Database.chats.query(Chat_.guid.equals(cachedGuid)).build();
