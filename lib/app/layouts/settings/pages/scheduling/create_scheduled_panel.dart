...
class _CreateScheduledMessageState
    extends OptimizedState<CreateScheduledMessage> {
  late final TextEditingController messageController =
      TextEditingController(text: widget.existing?.payload.message);
  final FocusNode messageNode = FocusNode();
  late final TextEditingController numberController = TextEditingController(
      text: widget.existing?.schedule.interval?.toString() ?? '1');

  late String selectedChat =
      widget.existing?.payload.chatGuid ?? chats.chats.first.guid;
          ...
          : FloatingActionButton(
              ...
              onPressed: () async {
                ...
                if (widget.existing != null) {
                  response = await http.updateScheduled(
                      widget.existing!.id,
                      selectedChat,
                  ...
                  response = await http.createScheduled(
                      selectedChat,
                      messageController.text,
                      date.toUtc(),
                      schedule == "once"
                ...
                if (response.statusCode == 200 && response.data != null) {
                  final data = widget.existing != null
                      ? widget.existing!.toJson()
                      : response.data['data'];
                  // merge new with old
                  if (widget.existing != null) {
                  ...
                  Logger.error(
                      "Scheduled message error: ${response.statusCode}");
            ...
            SettingsSection(backgroundColor: tileColor, children: [
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  maxLines: 14,
                  minLines: 1,
                  selectionControls: ss.settings.skin.value == Skins.iOS
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.all(Radius.circular(samsung ? 25 : 10)),
                    ),
            ...
            SettingsSection(
              ...
              children: [
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Padding(
                      ...
                      child: SettingsOptions<String>(
                        ...
                        initial: frequency,
                        textProcessing: (val) =>
                            "${frequencyToText[val]!.capitalizeFirst!}${interval == 1 ? "" : "s"}",
                        onChanged: (val) {
                          if (val == null) return;
                          setState(() {
                            frequency = val;
                ...
                SettingsTile(
                  ...
                  subtitle:
                      "Current: ${buildSeparatorDateSamsung(date)} at ${buildTime(date)}",
                  onTap: () async {
                    final newDate = await showTimeframePicker(
                        "Pick date and time", context,
                        presetsAhead: true);
