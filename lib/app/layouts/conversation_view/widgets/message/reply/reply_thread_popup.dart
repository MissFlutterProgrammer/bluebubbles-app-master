...
void showReplyThread(BuildContext context, Message message, MessagePart part,
    MessagesService service, ConversationViewController cvController) {
  final originatorPart = message.threadOriginatorGuid != null
      ? message.normalizedThreadPart
      : part.part;
  final _messages = service.struct
      .threads(message.threadOriginatorGuid ?? message.guid!, originatorPart);
  _messages.sort((a, b) => Message.sort(a, b, descending: false));
  _buildThreadView(_messages, originatorPart, cvController, context);
}

void showBookmarksThread(
    ConversationViewController cvController, BuildContext context) async {
  ...
  if (_messages.isEmpty) {
    return showSnackbar(
        "Error", "There are no bookmarked messages in this chat!");
  }
...
void _buildThreadView(List<Message> _messages, int? originatorPart,
    ConversationViewController cvController, BuildContext context) {
                                            ...
                                            child: AbsorbPointer(
                                              ...
                                              child: Padding(
                                                ...
                                                child: MessageHolder(
                                                  ...
                                                  oldMessageGuid: index > 0
                                                      ? _messages[index - 1]
                                                          .guid
                                                      : null,
                                                  newMessageGuid: index <
                                                          _messages.length - 1
                                                      ? _messages[index + 1]
                                                          .guid
                                                      : null,
