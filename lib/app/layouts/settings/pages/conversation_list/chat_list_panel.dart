                ...
                children: [
                  Obx(
                    () => SettingsSwitch(
                      ...
                      subtitle:
                          "Show a visual status indicator when the app is not connected to the server",
                      backgroundColor: tileColor,
                    ),
                  ),
                ...
                children: [
                  ...
                  Obx(
                    () => SettingsSwitch(
                      ...
                      backgroundColor: tileColor,
                      subtitle:
                          "Compresses chat tile size on the conversation list page",
                      isThreeLine: true,
                    ),
                  ),
                  const SettingsDivider(padding: EdgeInsets.only(left: 16)),
                    ...
                    Obx(() {
                      if (iOS) {
                        return const SettingsTile(
                          ...
                          subtitle:
                              "The row and column count of the pin grid. ",
                          isThreeLine: true,
                        );
                      } else {
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Flexible(
                                        child: SettingsOptions<int>(
                                          initial: ss.settings
                                              .pinColumnsLandscape.value,
                                          options: List.generate(
                                              5, (index) => index + 2),
                                          onChanged: (int? val) {
                                            if (val == null) return;
                                            ss.settings.pinColumnsLandscape
                                                .value = val;
                                            saveSettings();
                                          },
                                          title: "Pins Per Row",
                ...
                SettingsSection(
                  ...
                  children: [
                    Obx(() => SettingsSwitch(
                          ...
                          subtitle:
                              "Enables swipe actions for conversation tiles when using Material theme",
                          backgroundColor: tileColor,
                        )),
                    Obx(() {
                  ...
                  children: [
                    if (ss.settings.skin.value == Skins.iOS)
                      SettingsSwitch(
                        ...
                        subtitle:
                            "Replaces the floating button at the bottom to a fixed button at the top",
                        backgroundColor: tileColor,
                        isThreeLine: true,
                      ),
                    if (ss.settings.skin.value == Skins.iOS &&
