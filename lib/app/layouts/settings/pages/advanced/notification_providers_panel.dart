...
class _NotificationProvidersState
    extends OptimizedState<NotificationProvidersPanel> {
  @override
              ...
              SettingsSection(
                ...
                children: [
                  ...
                  SettingsTile(
                    title: "Unified Push",
                    subtitle:
                        "Receive notifications using a custom distributor",
                    onTap: () async {
                      ns.pushAndRemoveSettingsUntil(context, UnifiedPushPanel(),
                          (route) => route.isFirst);
                    },
                    leading: const SettingsLeadingIcon(
