...
class CustomAvatarColorPanel
    extends CustomStateful<CustomAvatarColorPanelController> {
  CustomAvatarColorPanel()
      : super(parentController: Get.put(CustomAvatarColorPanelController()));

  @override
  State<StatefulWidget> createState() => _CustomAvatarColorPanelState();
}

class _CustomAvatarColorPanelState extends CustomState<CustomAvatarColorPanel,
    void, CustomAvatarColorPanelController> {
  @override
          ...
          () => SliverList(
            delegate: SliverChildListDelegate(
              <Widget>[
                ...
                for (Widget handleWidget in controller.handleWidgets)
                  handleWidget,
              ],
            ),
          ),
