...
final balloonBundleIdIconMap = {
  ...
  'com.apple.DigitalTouchBalloonProvider': ss.settings.skin.value == Skins.iOS
  ...
  'com.apple.messages.MSMessageExtensionBalloonPlugin': {
    ...
    'be.nieldeckx.poll.extension': ss.settings.skin.value == Skins.iOS
        ? CupertinoIcons.doc_chart
        : Icons.ballot_outlined,
    'com.gamerdelights.gamepigeon.ext': ss.settings.skin.value == Skins.iOS
    ...
    'com.google.ios.youtube.MessagesExtension':
        ss.settings.skin.value == Skins.iOS
            ...
            : Icons.smart_display,
    'com.shazam.Shazam.imessageextension': ss.settings.skin.value == Skins.iOS
    ...
    'com.apple.PassbookUIService.PeerPaymentMessagesExtension':
        ss.settings.skin.value == Skins.iOS
            ...
            : Icons.attach_money,
    'com.google.Maps.MessagesExtension': ss.settings.skin.value == Skins.iOS
...
const windowsAppPackageName =
    "23344BlueBubbles.BlueBubbles_2fva2ntdzvhtw!bluebubbles";
