...
class _AttachmentPickerState extends OptimizedState<AttachmentPicker> {
  ...
  Future<void> getAttachments() async {
    ...
    if (list.isNotEmpty) {
      ...
      if (DateTime.now()
          .toLocal()
          .isWithin(_images.first.modifiedDateTime, minutes: 2)) {
                              ...
                              switch (index) {
                                ...
                                case 4:
                                  if (controller.pickedAttachments.isNotEmpty) {
                                    return showSnackbar(
                                      "Error",
                                      "Remove all attachments before scheduling!",
                                    );
                                  } else if (controller.replyToMessage !=
                                          null ||
                                      controller.subjectTextController.text
                                          .isNotEmpty) {
                                    return showSnackbar(
                                      "Error",
                                      "Private API features are not supported when scheduling!",
                                    );
                                  }
                                ...
                                case 5:
                                  Color selectedColor =
                                      context.theme.colorScheme.bubble(
                                          context, controller.chat.isIMessage);
                                  final result = (await ColorPicker(
                                    ...
                                    constraints: BoxConstraints(
                                      minHeight: 480,
                                      minWidth: ns.width(context) - 70,
                                      maxWidth: ns.width(context) - 70,
                                    ),
                                  ));
                                  if (result) {
                                                ...
                                                if (bytes != null) {
                                                  ...
                                                  controller.pickedAttachments
                                                    ...
                                                    PlatformFile(
                                                      path: null,
                                                      name:
                                                          "handwritten-${randomString(3)}.png",
                                                      bytes: uint8,
                        ...
                        (context, index) {
                          ...
                          return AttachmentPickerFile(
                            ...
                            onTap: () async {
                              ...
                              if (controller.pickedAttachments.firstWhereOrNull(
                                      (e) => e.path == file.path) !=
                                  null) {
                                controller.pickedAttachments
