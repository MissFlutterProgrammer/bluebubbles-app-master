          ...
          actions: [
                            ...
                            ConstrainedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTile(
                                    key: ValueKey(
                                      "${contacts[index].item1}-${contacts[index].item2}",
                                    ),
                ...
                if (selected?.item1 != null) {
                  if (!selected!.item1.isEmail) {
                    participantController.text =
                        cleansePhoneNumber(selected!.item1);
                  } else {
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                final response = await http.chatParticipant(
                    "add", chat.guid, participantController.text);
