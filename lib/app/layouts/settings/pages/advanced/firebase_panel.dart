        ...
        SliverList(
          delegate: SliverChildListDelegate(
            <Widget>[
                ...
                children: [
                  Obx(() {
                    ...
                    return SettingsTile(
                      ...
                      leading: SettingsLeadingIcon(
                        ...
                        containerColor:
                            _enabled ? Colors.green : Colors.redAccent,
                      ),
                    );
                  }),
                  Obx(() {
                  ...
                  Obx(() {
                    ...
                    return SettingsTile(
                      ...
                      subtitle:
                          'Download Firebase configurations directly from your server.',
                      trailing: Obx(
                        ...
                        Future.delayed(Duration.zero, () async {
                          try {
                            ...
                            if (hasConfigs) {
                              ...
                              error.value =
                                  "Firebase not configured on the server!";
                            }
                          } catch (e) {
                            Logger.error(
                              "Error loading Firebase Configurations: ${e.toString()}",
                            );
                          } finally {
                            ...
                            return AlertDialog(
                              ...
                              content: Obx(() {
                                if (isLoading.value) {
                                  ...
                                  return Text(
                                    error.value ??
                                        "Successfully loaded Firebase Configurations!",
                  ...
                  Obx(() {
                    ...
                    return SettingsTile(
                      ...
                      subtitle:
                          "Sign in with Google to load your Firebase configurations.",
                      backgroundColor: tileColor,
                      onTap: () {
                    ...
                    return SettingsTile(
                      ...
                      onTap: () async {
                        try {
                          ...
                          showSnackbar(
                            "Device Registered",
                            "Successfully re-registered device with server!",
                          );
                        } catch (e, s) {
                          Logger.error(
                              "Failed to re-register device with server",
                              error: e,
                              trace: s);
                          showSnackbar(
                            "Error",
                            "Failed to re-register device with server! Error: ${e.toString()}",
                          );
                        }
                      },
                    );
              ...
              Obx(() {
                final _enabled = ss.settings.firstFcmRegisterDate.value != 0 &&
                    !ss.fcmData.isNull;
                if (!_enabled) return const SizedBox.shrink();
                ...
                children: [
                  Obx(() {
                    ...
                    return Container(
                      child: Padding(
                        padding: const EdgeInsets.only(
                            bottom: 8.0, left: 22, top: 8.0, right: 15),
                        child: SelectableText.rich(
                          TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text: ss.fcmData.firebaseURL ?? "N/A",
                              ),
                            ],
                          ),
                        ),
                                ...
                                actions: <Widget>[
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      ss.settings.firstFcmRegisterDate.value =
                                          0;
                                      await ss.settings
                                          .saveOne('firstFcmRegisterDate');
                                      exit(0);
                                    },
                                  ),
                                ],
