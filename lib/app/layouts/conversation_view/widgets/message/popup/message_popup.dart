...
class _MessagePopupState extends OptimizedState<MessagePopup>
                    ...
                    if (ss.settings.enablePrivateAPI.value &&
                      ...
                      Positioned(
                        bottom: (iOS
                            ...
                            .clamp(
                          0,
                          context.height - (narrowScreen ? 200 : 125),
                        ),
                                        ...
                                        children: List.generate(
                                          ...
                                          return Row(
                                            ...
                                            children: ReactionTypes.toList()
                                                .slice(
                                                    narrowScreen && index == 1
                                                        ? 3
                                                        : 0,
                                                    narrowScreen && index == 0
                                                        ? 3
                                                        : null)
                                                .map((e) {
                                              return Padding(
  ...
  Widget buildDetailsMenu(BuildContext context) {
    double maxMenuWidth = min(max(ns.width(widthContext) * 3 / 5, 200),
        ns.width(widthContext) * 4 / 5);
                      ...
                      child: Padding(
                        padding: ss.settings.skin.value == Skins.iOS
                            ? const EdgeInsets.only(
                                ...
                                .add(
                                EdgeInsets.only(
                                    right: message.associatedMessageType ==
                                            "emphasize"
                                        ? 1
                                        : 0),
                              )
