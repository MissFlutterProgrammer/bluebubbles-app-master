...
class _BackupRestorePanelState extends OptimizedState<BackupRestorePanel> {
  ...
  void getBackups() async {
    ...
    if (response1.statusCode == 200 && response1.data['data'] != null) {
      ...
      settings.sort((a, b) =>
          DateTime.fromMillisecondsSinceEpoch(b['timestamp'] ?? 0).compareTo(
              DateTime.fromMillisecondsSinceEpoch(a['timestamp'] ?? 0)));
                                          ...
                                          onPressed: () {
                                            showDialog(
                                              ...
                                              builder: (context) => areYouSure(
                                                  ...
                                                  title: "Delete Backup?",
                                                  content: const Text(
                                                    "Are you sure you want to delete this settings backup?",
                                                  ),
                                                  onNo: () =>
                                      ...
                                      builder: (context) => areYouSure(context,
                                          ...
                                          onYes: () {
                                            ...
                                            try {
                                              ...
                                              showSnackbar(
                                                "Error",
                                                "Failed to restore settings backup! Error: ${e.toString()}",
                                              );
                                            }
                                          }),
                                    );
                          ...
                          child: ListTile(
                            ...
                            onTap: () async {
                              ...
                              void onDone(_context) async {
                                ...
                                } else if (settings.firstWhereOrNull(
                                        (s) => s["name"] == name) !=
                                    null) {
                                  bool yes = false;
                                  await showDialog(
                                ...
                                if (method) {
                                  var response =
                                      await http.setSettings(name, json);
                                  ...
                                  String directoryPath =
                                      "/storage/emulated/0/Download/BB-Settings-";
                                  ...
                                  showSnackbar(
                                    ...
                                    button: TextButton(
                                      ...
                                      onPressed: () {
                                        if (kIsDesktop) {
                                          launchUrl(
                                              Uri.file(dirname(filePath)));
                                        }
                                        Share.file(
                                            "BlueBubbles Settings", filePath);
                                      },
                                      child: Text(
                                          kIsDesktop ? "OPEN FOLDER" : "SHARE",
                                          style: TextStyle(
                              ...
                              showDialog(
                                ...
                                builder: (context) => areYouSure(context,
                                    ...
                                    onYes: () {
                                      Navigator.of(context).pop();
                                      try {
                                        String jsonString = const Utf8Decoder()
                                            .convert(res.files.first.bytes!);
                                        Map<String, dynamic> json =
                                    ...
                                    onPressed: () {
                                      showDialog(
                                        ...
                                        builder: (context) => areYouSure(
                                            ...
                                            title: "Delete Backup?",
                                            content: const Text(
                                                "Are you sure you want to delete this theme backup?"),
                                            onNo: () =>
                                                Navigator.of(context).pop(),
                                            onYes: () {
                                          ...
                                          onYes: () {
                                            ...
                                            try {
                                              ...
                                              Logger.error(
                                                  ...
                                                  trace: s);
                                              showSnackbar("Error",
                                                  "Failed to restore theme backup! Error: ${e.toString()}");
                                            }
                                          }),
                                    );
                                  },
                            ...
                            onTap: () async {
                              ...
                              if (method) {
                                ...
                                for (ThemeStruct e in allThemes) {
                                  var response = await http.setTheme(
                                      e.name.characters.take(50).string,
                                      e.toMap());
                                  if (response.statusCode != 200) {
                                    errored = true;
                                  }
                                ...
                                String directoryPath =
                                    "/storage/emulated/0/Download/BlueBubbles-theming-";
                                ...
                                builder: (context) => areYouSure(context,
                                    ...
                                    onYes: () {
                                      ...
                                      try {
                                        ...
                                        for (var e in json) {
                                          ThemeStruct object =
                                              ThemeStruct.fromMap(e);
                                          if (object.isPreset) continue;
                                          object.id = null;
                                          object.save();
                                        }
                                        showSnackbar("Success",
                                            "Theming restored successfully");
                                      } catch (e, s) {
                                        Logger.error(
                                            "Failed to restore theme backup!",
                                            error: e,
