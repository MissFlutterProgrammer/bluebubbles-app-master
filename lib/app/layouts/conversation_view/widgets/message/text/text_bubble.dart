...
class _TextBubbleState
    extends CustomState<TextBubble, void, MessageWidgetController> {
    ...
    return Container(
      constraints: BoxConstraints(
        maxWidth: message.isBigEmoji
            ? ns.width(context)
            : ns.width(context) * MessageWidgetController.maxBubbleSizeFactor -
                40,
        minHeight: 40,
      ),
      ...
      color: message.isFromMe! && !message.isBigEmoji
          ? (selected
              ...
              : context.theme.colorScheme.primary
                  .darkenAmount(message.guid!.startsWith("temp") ? 0.2 : 0))
          : null,
