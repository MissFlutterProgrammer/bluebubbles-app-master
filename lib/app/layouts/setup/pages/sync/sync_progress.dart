  ...
  void initState() {
    ...
    ever<SyncStatus>(syncManager.status, (event) async {
      ...
      if (event == SyncStatus.COMPLETED_ERROR) {
        await showDialog(
          context: context,
          builder: (context) => FailedToScanDialog(
              exception: err, title: "An error occured during setup!"),
        );
                  ...
                  children: [
                    ...
                    Obx(() => Padding(
                          padding: EdgeInsets.symmetric(
                              horizontal: ns.width(context) / 4),
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: LinearProgressIndicator(
                              value: syncManager.progress.value == 0
                                  ? null
                                  : syncManager.progress.value,
                              backgroundColor:
                        ...
                        child: Obx(
                          () => ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              Tuple2<LogLevel, String> log =
                                  syncManager.output.reversed.toList()[index];
                              return Text(
                                log.item2,
                                style: TextStyle(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "Finish",
                                  style:
                                      context.theme.textTheme.bodyLarge!.apply(
                                    fontSizeFactor: 1.1,
                                    color: Colors.white,
                                  ),
                                ),
