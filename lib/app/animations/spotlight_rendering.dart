...
class RenderSpotlight extends RenderBox {
  ...
  void _drawSpotlight(Canvas canvas) {
    if (controller.spotlight != null) {
      ...
      double pointX = screenWidth -
          (controller.spotlight!.originalPosition.y -
              controller.spotlight!.position.y);
      double pointY = 0;
      ...
      p2.arcToPoint(
          Offset(max(tangent1X, tangent2X), max(tangent1Y, tangent2Y)),
      ...
      canvas.drawPath(
        ...
        Paint()
          ...
          ..shader = RadialGradient(
            ...
            Rect.fromCircle(
              center: Offset(screenWidth, 0),
              radius: controller.spotlight!.position.y,
            ),
          ),
      );
    }
