      ...
      content: Column(
        ...
        children: <Widget>[
          ListTile(
            ...
            title: Text(
              chat.muteType == "mute" ? "Unmute" : "Mute",
          ...
          if (chat.isGroup)
            ListTile(
              ...
              onTap: () async {
                Get.back();
                List<String?> names =
                    chat.participants.map((e) => e.displayName).toList();
                          ...
                          return Column(
                            ...
                            children: [
                              const Padding(
                                ...
                                child: Text(
                                  "Select the individuals you would like to mute",
                                ),
                              ),
                              ConstrainedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  findChildIndexCallback: (key) =>
                                      findChildIndexByKey(chat.participants,
                    ...
                    actions: [
                      TextButton(
                          ...
                          onPressed: () {
                            ...
                            Get.back();
                            chat.save(
                                updateMuteType: true, updateMuteArgs: true);
                            updateParent.call();
                            eventDispatcher.emit("refresh", null);
                          }),
                    ],
          ...
          ListTile(
            ...
            title: Text(
              chat.muteType == "temporary_mute" &&
                      shouldMuteDateTime(chat.muteArgs)
