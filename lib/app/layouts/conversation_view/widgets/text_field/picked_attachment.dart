  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: iOS
          ...
          : const EdgeInsets.only(top: 15, left: 7.5, right: 7.5, bottom: 15),
      child: Stack(
          ...
          Container(
            ...
            child: OpenContainer(
                ...
                closedBuilder: (_, openContainer) {
                  return InkWell(
                    onTap: mime(widget.data.name)?.startsWith("image") ?? false
                        ? openContainer
                        : null,
                    child: Stack(
                      clipBehavior: Clip.none,
                              ...
                              onPressed: () {
                                if (widget.controller != null) {
                                  widget.controller!.pickedAttachments
                                      .removeWhere(
                                          (e) => e.path == widget.data.path);
                                  widget.controller!.chat.textFieldAttachments
                                      .removeWhere(
                                          (e) => e == widget.data.path);
                                  widget.controller!.chat
                                      .save(updateTextFieldAttachments: true);
                                } else {
            ...
            Positioned(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  if (widget.controller != null) {
                    widget.controller!.pickedAttachments
                        .removeWhere((e) => e.path == widget.data.path);
                    widget.controller!.chat.textFieldAttachments
