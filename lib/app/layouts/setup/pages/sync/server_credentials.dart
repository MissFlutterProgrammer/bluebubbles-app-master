...
class _ServerCredentialsState extends OptimizedState<ServerCredentials> {
  ...
  Widget build(BuildContext context) {
    ...
    return SetupPageTemplate(
      ...
      contentWrapper: (child) => AnimatedSize(
        ...
        child: !showLoginButtons && context.isPhone
                            ...
                            child: Focus(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: "Password",
                                  contentPadding:
                                      const EdgeInsets.fromLTRB(12, 24, 40, 16),
  ...
  Future<void> scanQRCode() async {
    ...
    if (!status.isPermanentlyDenied && !status.isGranted) {
      ...
      showSnackbar("Error",
          "Camera permission permanently denied, please modify permissions from Android settings.");
      return;
    }
  ...
  Future<void> connect(String url, String password) async {
    ...
    if (kIsWeb && url.startsWith("http://")) {
      controller.updateConnectError(
          "HTTP URLs are not supported on Web! You must use an HTTPS URL.");
      return;
    }
    ...
    if (serverResponse?.statusCode == 401) {
      ...
      return controller
          .updateConnectError("Authentication failed. Incorrect password!");
    }
    ...
    if ((data == null || isNullOrEmpty(data["data"])) &&
      ...
      return controller.updateConnectError(
          "Firebase is required when using Ngrok or Cloudflare!");
    } else {
      try {
