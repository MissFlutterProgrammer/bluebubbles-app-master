...
class _ProfilePanelState extends OptimizedState<ProfilePanel>
  ...
  void updateName() async {
    final nameController =
        TextEditingController(text: ss.settings.userName.value);
    done() async {
                    ...
                    children: [
                      ...
                      if (accountInfo['active_alias'] != null)
                        SettingsOptions<String>(
                          ...
                          clampWidth: false,
                          options: accountInfo['vetted_aliases']
                              .map((e) => e['Alias'].toString())
                              .toList()
                              .cast<String>(),
