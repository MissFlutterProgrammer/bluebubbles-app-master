...
class _NotificationPanelState extends OptimizedState<NotificationPanel>
          ...
          <Widget>[
            if (ss.settings.skin.value != Skins.Samsung)
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    "Notifications".psCapitalize,
                    style: iOS ? iosSubtitle : materialSubtitle,
                  ),
                ),
              ),
            SettingsSection(backgroundColor: tileColor, children: [
              ...
              SettingsTile(
                ...
                backgroundColor: tileColor,
                subtitle:
                    "Mute all chats except when your choice of text is found in a message",
              ),
            ]),
            SettingsHeader(
            ...
            SettingsSection(
              ...
              children: [
                Obx(() => SettingsSwitch(
                      ...
                      subtitle:
                          "Replaces message text with 'iMessage' in notifications",
                      backgroundColor: tileColor,
                    )),
                const SettingsDivider(padding: EdgeInsets.only(left: 16.0)),
                Obx(() => SettingsSwitch(
                      ...
                      subtitle:
                          "Show a snackbar whenever a message sync is completed",
                      backgroundColor: tileColor,
                      isThreeLine: true,
                    )),
              ],
    ...
    if (chat.muteType == null) {
      ...
      if (chat.muteArgs != null) {
        if (chat.muteType == "mute_individuals") {
          final participants = chat.participants.where(
              (element) => chat.muteArgs!.split(",").contains(element.address));
          muteArgsStr =
              " - ${participants.length > 1 ? "${participants.length} people" : "1 person"}";
                  ...
                  child: ScrollbarWrapper(
                    ...
                    child: ListView.builder(
                      ...
                      findChildIndexCallback: (key) => findChildIndexByKey(
                          chats.chats, key, (item) => item.guid),
                        ...
                        return ConversationTile(
                          ...
                          onSelect: (_) async {
                            ...
                            await showDialog(
                              context: context,
                              builder: (context) =>
                                  NotificationSettingsDialog(chat, () {
                                setState(() {});
                              }),
                            );
                          },
