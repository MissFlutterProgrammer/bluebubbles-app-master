...
class _MaterialHeaderState
    extends CustomState<MaterialHeader, void, ConversationListController> {
      ...
      children: [
        Obx(
          () => Container(
            ...
            color: ss.settings.windowEffect.value == WindowEffect.disabled
                  ...
                  child: Obx(() {
                    ...
                    return Container(
                      decoration: BoxDecoration(
                        color: !ns.isAvatarOnly(context) &&
                                !showArchived &&
                                !showUnknown
                            ? context.theme.colorScheme.properSurface
                                .withOpacity(ss.settings.windowEffect.value ==
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ]).contains(controller.selectedChats
                                .where((element) => element.hasUnreadMessage!)
                                .length))
                              IconButton(
                                onPressed: () {
                                  for (Chat element
                                      in controller.selectedChats) {
                                    element.toggleHasUnread(
                                        !element.hasUnreadMessage!);
                                  }
                                  controller.clearSelectedChats();
                                },
                                icon: Icon(
                            ...
                            if (([
                              ...
                              controller.selectedChats.length
                                ...
                                .where((element) => element.muteType == "mute")
                                .length))
                              IconButton(
                                onPressed: () {
                                  for (Chat element
                                      in controller.selectedChats) {
                                    element
                                        .toggleMute(element.muteType != "mute");
                                  }
                                  controller.clearSelectedChats();
                                },
                                icon: Icon(
                            ...
                            if (([0, controller.selectedChats.length]).contains(
                              ...
                              IconButton(
                                ...
                                icon: Icon(
                                  controller.selectedChats[0].isPinned!
