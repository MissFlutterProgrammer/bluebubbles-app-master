...
Future<void> peekChat(BuildContext context, Chat c, Offset offset) async {
  ...
  final messages = Chat.getMessages(c, getDetails: true)
      .where((e) => e.associatedMessageGuid == null)
      .toList();
...
class _ConversationPeekViewState extends OptimizedState<ConversationPeekView>
      ...
      child: Theme(
        data: context.theme.copyWith(
          ...
          colorScheme: context.theme.colorScheme.copyWith(
            primary: context.theme.colorScheme
                .bubble(context, widget.chat.isIMessage),
            onPrimary: context.theme.colorScheme
                .onBubble(context, widget.chat.isIMessage),
          ...
          child: Container(
            child: Stack(
              ...
              children: [
                ...
                Positioned(
                  left: min(widget.position.dx,
                      context.width - min(context.width - 50, 500) - 25),
                  top: min(
                    widget.position.dy,
                    context.height -
                        min(context.height / 2,
                            context.height - itemHeight * 5) -
                        itemHeight * 5 -
                        25,
                  ),
                                ...
                                child: Padding(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    findChildIndexCallback: (key) =>
                                        findChildIndexByKey(widget.messages,
                                            key, (item) => item.guid),
                                      ...
                                      return AbsorbPointer(
                                        ...
                                        child: Material(
                                          ...
                                          child: Padding(
                                            ...
                                            child: MessageHolder(
                                              key: Key(
                                                  widget.messages[index].guid!),
                                              cvController: cvController,
                                              message: widget.messages[index],
                                              oldMessageGuid: index ==
                                                      widget.messages.length - 1
                                                  ? null
                                                  : widget
                                                      .messages[index + 1].guid,
                                              newMessageGuid: index == 0
                                                  ? null
                                                  : widget
                                                      .messages[index - 1].guid,
                                            ),
  ...
  Widget buildDetailsMenu(BuildContext context) {
    double maxMenuWidth =
        min(max(context.width * 3 / 5, 200), context.width * 4 / 5);
    ...
    List<Widget> allActions = [
      ...
      Material(
        ...
        child: InkWell(
          onTap: () async {
            widget.chat
                .toggleHasUnread(!widget.chat.hasUnreadMessage!, force: true);
            popPeekView();
          },
          child: ListTile(
            mouseCursor: MouseCursor.defer,
          ...
          child: ListTile(
            ...
            trailing: Icon(
              widget.chat.isArchived!
                  ? (ios
                      ? cupertino.CupertinoIcons.tray_arrow_up
                      : Icons.unarchive)
                  : (ios
                      ? cupertino.CupertinoIcons.tray_arrow_down
                      : Icons.archive),
              color: context.theme.colorScheme.properOnSurface,
            ),
          ),
