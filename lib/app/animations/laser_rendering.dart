...
class RenderLaser extends RenderBox {
  ...
  void _drawLasers(Canvas canvas) {
    if (controller.laser != null) {
      ...
      double screenHeight =
          max(controller.windowSize.height, controller.windowSize.width) *
              sqrt(2);
      Color color =
          HSVColor.fromAHSV(1, controller.globalHue % 360, 1, 1).toColor();
      p.addArc(
          Rect.fromCenter(
          ...
          Paint()
            ...
            ..shader = RadialGradient(colors: [
              ...
              0.9
                ...
                center: Offset(centerX, centerY),
                radius: screenHeight * 2 - 100)));
      for (LaserBeam b in controller.beams) {
        final Path p2 = Path();
        p2.moveTo(centerX, centerY);
        p2.lineTo(
            centerX +
                screenHeight * cos(b.globalAngle) -
                b.internalWidth * sin(b.globalAngle),
            centerY +
                screenHeight * sin(b.globalAngle) +
                b.internalWidth * cos(b.globalAngle));
        p2.lineTo(
            centerX +
                screenHeight * cos(b.globalAngle) +
                b.internalWidth * sin(b.globalAngle),
