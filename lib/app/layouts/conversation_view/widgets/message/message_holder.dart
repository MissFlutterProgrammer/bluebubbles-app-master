...
class _MessageHolderState
  ...
  bool get showSender =>
      ...
      (!message.sameSender(olderMessage) ||
          ...
          (olderMessage == null ||
              !message.dateCreated!.isWithin(
                olderMessage!.dateCreated!,
                minutes: 30,
              )));
  ...
  void completeEdit(String newEdit, int part) async {
    widget.cvController.editing.removeWhere(
        (e2) => e2.item1.guid == message.guid! && e2.item2.part == part);
    if (newEdit.isNotEmpty &&
        newEdit !=
            messageParts.firstWhere((element) => element.part == part).text) {
      showDialog(
          context: context,
      ...
      final response = await http.edit(
          message.guid!, newEdit, "Edited to: “$newEdit”",
          partIndex: part);
                            ...
                            children: [
                              ...
                              if (iOS &&
                                ...
                                Padding(
                                  ...
                                  child: DecoratedBox(
                                    decoration:
                                        replyTo!.isFromMe == message.isFromMe
                                            ? ReplyLineDecoration(
                                    ...
                                    child: Container(
                                      ...
                                      alignment: replyTo!.isFromMe!
                                          ? Alignment.centerRight
                                          : Alignment.centerLeft,
                                      child: ReplyBubble(
                                        parentController:
                                            getActiveMwc(replyTo!.guid!)!,
                                        part: replyTo!.guid! ==
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (message
                                                                            .isFromMe!)
                                                                          Obx(() {
                                                                            final editStuff = widget.cvController.editing.firstWhereOrNull((e2) =>
                                                                            ...
                                                                            return AnimatedSize(
                                                                              ...
                                                                              child: editStuff == null
                                                                                  ...
                                                                                  : Material(
                                                                                      ...
                                                                                      child: Container(
                                                                                        decoration: BoxDecoration(
                                                                                          color: !message.isBigEmoji ? context.theme.colorScheme.primary.darkenAmount(message.guid!.startsWith("temp") ? 0.2 : 0) : context.theme.colorScheme.surface,
                                                                                        ),
                                                                                        constraints: BoxConstraints(
                              ...
                              Padding(
                                padding: showAvatar ||
                                    ...
                                    ? EdgeInsets.only(
                                        left:
                                            35 * ss.settings.avatarScale.value,
                                      )
                                    : EdgeInsets.zero,
