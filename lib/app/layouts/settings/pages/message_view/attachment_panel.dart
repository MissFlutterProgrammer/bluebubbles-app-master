                  ...
                  children: [
                    ...
                    if (!kIsWeb && !kIsDesktop)
                      Obx(() => SettingsSwitch(
                            ...
                            subtitle:
                                "Automatically saves all attachments to folders selected below",
                            backgroundColor: tileColor,
                            isThreeLine: true,
                          )),
                    if (!kIsWeb && !kIsDesktop)
                    ...
                    if (!kIsWeb && !kIsDesktop)
                      Obx(() => SettingsTile(
                            ...
                            subtitle:
                                "Saving images and videos to ${ss.settings.autoSavePicsLocation.value}",
                            backgroundColor: tileColor,
                            onTap: () async {
                              ...
                              await showDialog(
                                  ...
                                  builder: (_) {
                                    return AlertDialog(
                                        ...
                                        TextButton(
                                          ...
                                          onPressed: () async {
                                            if (pathController.text.isEmpty) {
                                              Get.back();
                                              ss.settings.autoSavePicsLocation
                                                  .value = "Pictures";
                                            } else {
                                              final regex =
                                      ...
                                      title: Text("Enter Relative Path",
                                          style: context
                    ...
                    if (!kIsWeb && !kIsDesktop)
                      Obx(() => SettingsTile(
                            ...
                            subtitle:
                                "Saving documents and videos to ${ss.settings.autoSaveDocsLocation.value.replaceAll("/storage/emulated/0/", "")}",
                            backgroundColor: tileColor,
                            onTap: () async {
                              final savePath =
                                ...
                                dialogTitle:
                                    'Choose a location to auto-save documents',
                    ...
                    if (!kIsWeb && !kIsDesktop)
                      Obx(() => SettingsSwitch(
                            ...
                            subtitle:
                                "Ask where to save attachments when manually downloading",
                            backgroundColor: tileColor,
                            isThreeLine: true,
                          )),
                  ],
                  ...
                  SettingsSection(
                    ...
                    children: [
                      ...
                      Obx(() => SettingsOptions<SwipeDirection>(
                            ...
                            subtitle:
                                "Set the swipe direction to go to previous media items",
