...
void sendEffectAction(
  ...
  if (textSplit.length > 1) {
    for (String word in textSplit) {
      ...
      newText.add(
        word.replaceAll(
          MentionTextEditingController.escapingChar,
          "",
        ),
      );
    }
  ...
  final FireworkController fireworkController = FireworkController(
    vsync: provider,
    windowSize: Size(
      ns.width(context),
      context.height,
  ...
  final CelebrationController celebrationController = CelebrationController(
    vsync: provider,
    windowSize: Size(
      ns.width(context),
      context.height,
  ...
  final BalloonController balloonController = BalloonController(
    vsync: provider,
    windowSize: Size(
      ns.width(context),
      context.height,
  ...
  final LoveController loveController = LoveController(
    vsync: provider,
    windowSize: Size(
      ns.width(context),
      context.height,
  ...
  final LaserController laserController = LaserController(
    vsync: provider,
    windowSize: Size(
      ns.width(context),
      context.height,
                                                        ...
                                                        if (key.globalPaintBounds(
                                                          ...
                                                          laserController
                                                              ...
                                                              Size(
                                                                  ...
                                                                  context
                                                                      .height);
                                                          laserController.start(
                                                              key.globalPaintBounds(
                                                                  context)!);
                                                          await Future.delayed(
                                                            const Duration(
                                                                seconds: 1),
                                      ...
                                      Theme(
                                        data: context.theme.copyWith(
                                          ...
                                          colorScheme: context.theme.colorScheme
                                            ...
                                            surface: ss.settings.monetTheming
                                                        .value ==
                                                    Monet.full
                                                ? null
                                                : (context.theme.extensions[
                                                        ...
                                                        as BubbleColors?)
                                                    ?.receivedBubbleColor,
                                            onSurface: ss.settings.monetTheming
                                                        .value ==
                                                    Monet.full
                                                ? null
                                                : (context.theme.extensions[
